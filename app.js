...
const wluBuildings =[
    ...
    {name: "Arts E Entrance",description: "Arts Building",img:"images/artsace.png",pos:[], graph_name: "artsc_s"},
   ...
   // {name: "Concourse (Back)",description: "concourse back",img:"images/concback.png",pos: [], graph_name: ""},
    ...
    {name: "Arts C Entrance", description: " Arts Building West Entrance", img: "images/artswest.png", pos: [], graph_name: "artse_e"},
    ...
    {name: "Science Building (North)", description: "Science Building North Entrance", img: "images/sciencenorth.png", pos: [], graph_name: "science_ne"},
    {name: "Science Building (North West)", description: "Science Building North West Entrance", img: "images/sciencenorthw.png", pos: [], graph_name: "science_nw"},
    {name: "Science Building (South East)", description: "Science Building South East Entrance", img: "images/sciencesouthe.png", pos: [], graph_name: "science_se"},
    {name: "Science Building (South West)", description: "Science Building South West Entrance", img: "images/sciencesouthw.png", pos: [], graph_name: "science_sw"}
];
